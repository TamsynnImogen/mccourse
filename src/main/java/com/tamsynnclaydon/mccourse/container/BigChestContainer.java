...
public class BigChestContainer extends Container
{
    ...
    public BigChestContainer(int id, World world, BlockPos pos, PlayerInventory playerInv, int numCols, int numRows)
    {
        super(ModContainers.BIGCHEST_CONTAINER.get(), id);
        ...
        if(tileEntity != null)
        {
            tileEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent( handler -> {
                ...
                GenerateChestInventorySlots(handler);
                GeneratePlayerInventorySlots(handler);
    ...
    private void GenerateChestInventorySlots(IItemHandler handler)
    {
    ...
    private void GeneratePlayerInventorySlots(IItemHandler handler)
    {
