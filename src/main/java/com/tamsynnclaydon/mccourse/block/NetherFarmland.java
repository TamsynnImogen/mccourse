...
public class NetherFarmland extends Block
{
    ...
    public NetherFarmland(AbstractBlock.Properties builder) {
        super(builder);
    ...
    public BlockState getStateForPlacement(BlockItemUseContext context) {
        return !this.getDefaultState().isValidPosition(context.getWorld(), context.getPos()) ? Blocks.SOUL_SOIL.getDefaultState() : super.getStateForPlacement(context);
    }
