...
import com.tamsynnclaydon.mccourse.block.ModGenericChest;
...
public class ModGenericChestTileEntity extends LockableLootTileEntity implements IChestLid, ITickableTileEntity {
    ...
    protected ModGenericChestTileEntity(TileEntityType<?> typeIn, IronChestsTypes chestTypeIn, Supplier<Block> blockToUseIn) {
        super(typeIn);
    ...
    protected void onOpenOrClose() {
        ...
        if (block instanceof ModGenericChest) {
    ...
    public static int getPlayersUsing(IBlockReader reader, BlockPos posIn) {
        ...
        if (blockstate.hasTileEntity()) {
            ...
            if (tileentity instanceof ModGenericChestTileEntity) {
                return ((ModGenericChestTileEntity) tileentity).numPlayersUsing;
            }
        }
    ...
    public IronChestsTypes getChestType() {
        ...
        if (this.hasWorld()) {
            IronChestsTypes typeFromBlock = ModGenericChest.getTypeFromBlock(this.getBlockState().getBlock());
