...
public class BigChestTileEntityRenderer<T extends TileEntity & IChestLid> extends ChestTileEntityRenderer<T>
{
    ...
    public BigChestTileEntityRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
